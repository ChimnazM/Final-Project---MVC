...
namespace MvcFinalProject.Migrations
{
    ...
    [Migration("20220402000806_CreateContactpgTable")]
    partial class CreateContactpgTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvcFinalProject.Models.ContactPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcFinalProject.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcFinalProject.Models.EventSpeaker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcFinalProject.Models.Speaker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcFinalProject.Models.EventSpeaker", b =>
                {
                    b.HasOne("MvcFinalProject.Models.Event", "Event")
                        .WithMany("EventSpeakers")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MvcFinalProject.Models.Speaker", "Speaker")
                        .WithMany("EventSpeakers")
