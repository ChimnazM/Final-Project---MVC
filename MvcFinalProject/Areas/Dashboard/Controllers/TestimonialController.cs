...
namespace MvcFinalProject.Areas.Dashboard.Controllers
{
    public class TestimonialController : Controller
    {
        ...
        public async Task<IActionResult> Create(Testimonial t)
        {
            ...
            t.MainImage = FileUtils.Create(FileConstants.ImagePathTestimomial, t.ImageFile);
        ...
        public async Task<IActionResult> DeleteBlog(int id)
        {
            ...
            FileUtils.Delete(Path.Combine(FileConstants.ImagePathTestimomial, t.MainImage));
