...
namespace MvcFinalProject.Areas.Dashboard.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public async Task<IActionResult> Update(int id, EventPostVM events)
        {
            ...
            events.Event.ImageMain = FileUtils.Create(FileConstants.ImagePathEvent, events.Event.ImageFile);
            events.Event.ImageDetail = FileUtils.Create(FileConstants.ImagePathEvent, events.Event.ImageFile);
            EventVM model = new EventVM
            {
                Event = events.Event,
        ...
        public async Task<IActionResult> Create(EventPostVM model)
        {
            ...
            Event eventt = new Event
            {
                ...
                VenueMain = model.VenueMain,
                Date = model.Date,
                Time = model.Time,
                VenueDetail = model.VenueDetail,
                ImageMain = FileUtils.Create(FileConstants.ImagePathEvent, model.ImageFile),
                ImageDetail = FileUtils.Create(FileConstants.ImagePathEvent, model.ImageFile),
        ...
        public async Task<IActionResult> DeleteEvent(int id)
        {
            ...
            FileUtils.Delete(Path.Combine(FileConstants.ImagePathEvent, eventt.ImageMain));
            FileUtils.Delete(Path.Combine(FileConstants.ImagePathEvent, eventt.ImageDetail));
